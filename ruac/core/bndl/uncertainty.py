...
"""Analytic uncertainty from BNDL Weibull parameters.

Computes Bernoulli entropy uncertainty in closed form using a MacKay-probit
approximation of ``E[sigmoid(X)]`` plus log-space Weibull variance arithmetic
for numerical stability.

References:
    * MacKay (1992) "The Evidence Framework Applied to Classification Networks"
    * Bishop (2006) "Pattern Recognition and Machine Learning", §4.5.2
"""
...
# Precomputed constants from BNDL — kept here so callers do not need to
# import the BNDL submodule directly.
